...
- Под ответом сначала видны три компактных источника. Нажмите `Показать ещё`, если нужны остальные,
  и раскройте конкретную страницу: только тогда загрузится исходный скриншот со стрелками,
  выделениями и значениями полей.
...
Ссылка из Word показывается кликабельно и открывается в новой вкладке. Для проверки подписи,
кнопки или скриншота раскройте источник с нужной страницей. Если адреса в исходном файле нет,
система должна прямо сообщить об этом, а не придумывать URL.
